...
var finfn = function(key, reduced) {
	...
	return {"countryID" : key, "city1": city1.name, "city2": city2.name, "dist": min_dist, "Code": city1.Code};
}

db.cities.mapReduce(mapfn, redfn, 
    { out: cname , finalize: finfn,
      query: {
